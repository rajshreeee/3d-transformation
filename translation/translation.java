...
public class  translation{
	...
	public static void drawTriangle(){
		  ...
		  GL2 gl = eventlistener.gl;
			...
			gl.glVertex3f(0, 0, 1);
			gl.glEnd();
			translate(x1, y1, z1, x2, y2, z2, x3, y3, z3);
			matrixMultiply(x1, y1, z1, x2, y2, z2, x3, y3, z3, O);
	}
	

		
		public static void translate(int a, int b, int c, int d, int e, int f, int g, int h, int i) {
			 GL2 gl = eventlistener.gl;
		...
		{
			int [][]A = { 1, 0, 0, tx, 0, 1, 0, ty, 0, 0, 1, tz, 0, 0, 0, 1 }; [][]B = { x1, y1, z1, 1 };
			int [][]C = { x2, y2, z2, 1 };
			int [][]D = { x3, y3, z3, 1 };
